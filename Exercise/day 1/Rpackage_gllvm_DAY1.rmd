...
## Distributions
```{r, echo=FALSE}
tabl <- read.table("tabd.txt", header = TRUE)
library(knitr)
library(kableExtra)
kable(tabl, booktabs = TRUE) %>%
    row_spec(c(4,5,7,9), background = 'lightgrey') %>%
    kable_styling(font_size = 19,latex_options = "striped")
```
